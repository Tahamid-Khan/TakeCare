<x-guest-layout>
    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!--        <button type="button" onclick="showPassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5 text-gray-500 focus:outline-none">-->
            <!--            <svg width="18" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">-->
            <!--                <path d="M12 4.5C6 4.5 1.73 8.11 0 12c1.73 3.89 6 7.5 12 7.5s10.27-3.61 12-7.5c-1.73-3.89-6-7.5-12-7.5zm0 12.5c-2.92 0-5.28-2.35-5.28-5.25S9.08 6.5 12 6.5s5.28 2.35 5.28 5.25S14.92 17 12 17zm0-8c-1.52 0-2.75 1.22-2.75 2.75S10.48 14.5 12 14.5s2.75-1.22 2.75-2.75S13.52 9 12 9zm0 4.5c-.98 0-1.75-.77-1.75-1.75S11.02 10 12 10s1.75.77 1.75 1.75S12.98 13.5 12 13.5z" fill="currentColor"/>-->
            <!--            </svg>-->
            <!--        </button>-->
            <!--    </div>-->
