                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="h3">Generate report for test no-{{ $test->id  }},
                                    patient-{{ $test->patient->name }}</h3>
                            </div>
                            <form action="{{ route('pathology.report-generate-post', $test->id) }}" class="p-2" method="POST" enctype="multipart/form-data">@csrf
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <div class="card p-3">
                                                    <ul>
                                                        @php
                                                            $materials =json_decode($test->materials);
                                                        @endphp
                                                        @foreach($materials as $material)
                                                            <li>
                                                                <i class="fas fa-arrow-right text-primary"></i>
                                                                <strong class="capitalize">  {{ $material->name }}: </strong>{{ $material->id }}
