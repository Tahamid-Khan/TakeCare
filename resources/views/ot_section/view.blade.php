        ...
        <section class="content">
            <div class="">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <h2 class="card-header h2">Patient Details</h2>
                            <div class="card-body">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <p class="my-2"><strong>Address : </strong>{{ $patientLists->address ?? '' }}
                                        </p>
                                        <p class="my-2"><strong>Blood Group
                                                : </strong>{{ $patientLists->blood_group ?? '' }} </p>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <p class="my-2"><strong>Summary
                                                : </strong>{{ $patientLists->patient_summary ?? '' }} </p>
                                        <p class="my-2"><strong>Doctor : </strong>{{ $doctor->name ?? '' }} </p>
                                        <p class="my-2"><strong>Type : </strong>{{ $patientLists->patient_type ?? '' }}
                                        </p>
                                        <p class="my-2"><strong>Reference
                                                : </strong>{{ $patientLists->reference ?? '' }} </p>
                                    </div>
                                </div>


                                <div>
                                    @include('ot_section.tab-item')
                                </div>
                            </div>
                        </div>
                    </div>
