    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="mb-4 rounded-lg bg-white p-4 shadow-md">
                <h2 class="mb-4 text-xl font-semibold">Others</h2>
                        ...
                        <div class="modal-content">
                            <form action="" method="POST">@csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3 form-group">
                                        <label for="expenseGoesUnder" class="form-label">Goes Under</label>
                                        <input type="text" class="form-control" name="goesUnder" id="expenseGoesUnder" placeholder="Expense Goes To">
                                    </div>
