                ...
                <div class="card-header">
                    <div class="row info-section">
                        ...
                        @if ($patientData->mlc !== null)
                            ...
                            <div class="col-md-4">
                                <h5>MLC Details</h5>
                                <p><strong>Case ID:</strong> {{ $mlc->case_id ?? 'N/A' }}</p>
                                <p><strong>Police Station:</strong> {{ $mlc->police_station ?? 'N/A' }}</p>
                                <p><strong>Officer Name:</strong> {{ $mlc->officer_name ?? 'N/A' }}</p>
                                <p><strong>Officer Contact:</strong> {{ $mlc->officer_contact ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-4">
                                <h5>Other Details</h5>
                                <div>
                                    <div><strong>Document:</strong></div>
                                    @if (isset($mlc->document) && !empty($mlc->document))
                                        <div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @if (isset($mlc->document) && !empty($mlc->document) && file_exists(public_path('uploads/emergency/' . $mlc->document)))
                                    <embed src="{{ asset('uploads/emergency/' . $mlc->document) }}" type="application/pdf"
                                        width="100%" height="600px">
                                @else
                                    <p>Document not available or file not found.</p>
                                @endif
                            </div>
                        </div>
                    </div>
