<div>
    <div class="">
        <h2 class="h2 mb-4">Patient's Operation List</h2>
    ...
    <div class="modal fade" id="show-timeline-modal" tabindex="-1" role="dialog"
         aria-labelledby="showTimelineModal"
         aria-hidden="true">
