                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="h2">Create Invoice for Operation</h2>
                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <p class="my-2"><strong>Ref. By
                                                        : </strong>{{ $patientData->requestedByUser->name }} </p>
                                    ...
                                    <form action="{{ route('reception.payment.store') }}" method="POST">@csrf
                                        <div class="row">
                                            <div class="col-xl-9" style="border-right: 1px solid #6c757d4a;">
                                                <div style="min-height: 220px; padding: 00px; background:#fafafa;">
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td>{{ $patientData->operation_date }}</td>
                                            ...
                                            <div>
                                                ...
                                                <input type="hidden" name="operation_id" value="{{ $patientData->id }}">
                                            </div>
