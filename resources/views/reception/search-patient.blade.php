                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row justify-content-between">
                                    <h3 class="h3">Search Existing Patient</h3>
                                    <div>
                                        <a href="{{ route('reception.opd-registration') }}" class="btn btn-primary">Add New Patient</a>
                                    </div>
                                </div>
                            </div>
                            <form action="" method="POST">@csrf
                                <div class="row align-items-center m-4">
                                    <div class="form-group col-12 col-md-5">
                                        ...
                                        <input type="text" name="patient_id" class="form-control" id="searchById" placeholder="Enter Patient ID">
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-5">
                                        ...
                                        <input type="text" name="mobile" class="form-control" id="searchByPhoneNumber" placeholder="Enter Phone Number">
                                    </div>
                                </div>
                                <div class="m-4">
